...
class DemoTest {
    ...
    // Move backward
    @Test
    void should_at_0_neg1_N_when_move_backward_given_0_0_N() {
        // Given
        Location location = new Location(Direction.N);
        // When
        String command = "B";
    ...
    @Test
    void should_at_neg1_0_E_when_move_backward_given_0_0_E() {
        // Given
        Location location = new Location(Direction.E);
        // When
        String command = "B";
    ...
    @Test
    void should_at_0_1_S_when_move_backward_given_0_0_S() {
        // Given
        Location location = new Location(Direction.S);
        // When
        String command = "B";
    ...
    @Test
    void should_at_1_0_W_when_move_backward_given_0_0_W() {
        // Given
        Location location = new Location(Direction.W);
        // When
        String command = "B";
